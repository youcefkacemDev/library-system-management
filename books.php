...
<body>
    <div class="options">
        ...
        <div>
            <form action="" method="get">
                <form action="" method="get">
                    <input class="item" id="search_category" type="search" name="search_book" placeholder="Book Search...">
                </form>
            </form>
        </div>
        <div>
    ...
    <div>
        <?php
            if(isset($_GET['search_book'])){
                $_COOKIE['search_book'] = $_GET['search_book'];
            }
            if(isset($_GET['sort'])){
                $_COOKIE['sort'] = $_GET['sort'];
            }
            include_once("gets/book.get.php")
        ?>
    </div>
</body>
</html>